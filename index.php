...
<body>
    ...
    <div class="col-md-6 well  container">
        <div class="fix" style="background-color: #ffffff79; border-radius:20px; padding:35px; width:50%;">
            <div class="cet">
                <h3 class="text" style="font-size:24px; margin-right:20px; font-weight:bold;">Sign in with your U-Drive ID</h3>
            ...
            <div class="col">
                ...
                <form method="POST" action="">
                    ...
                    <div class="custom-style">
                        <a href="signup.php" style="font-size:14px; text-decoration:none; font-weight:bold;">Not a member yet? Register here...</a>
                    </div>
